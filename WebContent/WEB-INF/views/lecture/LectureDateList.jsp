...
<link rel="stylesheet" type="text/css"
	href="<%=cp%>/assets/css/lecture/lectureDateList.css">
</head>
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-8 col-md-8-center" id="col-md-8"
		...
		<div class="row">
			...
			<div class="col-md-12 box1">
				...
				<div class="box2">
					...
					<div class="time">
						<h3>
							<span class="glyphicon glyphicon-time"></span> 2020년 6월 22일 오후 1: 00
						</h3>
					</div>
					<!-- end .time -->
					...
					<div class="location">
						<h3>
							<span class="glyphicon glyphicon-map-marker"></span> 서울 마포구 홍대입구역 할리스
						</h3>
					</div>
					<!-- end .location -->
				...
				<div class="box3">
					...
					<div class="mem">
						...
						<div class="memImg">
							<img alt="Bootstrap Image Preview" src="assets/images/hjkim.PNG"
						...
						<div class="memAtten">
							...
							<div class="answer1">
								<input type="radio" name="" id="" class="attendance" />
								<span class="yes">참여</span>
							</div>
							
							<div class="answer2">
								<input type="radio" name="" id="" class="attendance" checked="checked" />
								<span class="no">불참</span>
							</div>
					...
					<div class="mem">
						...
						<div class="memImg">
							<img alt="Bootstrap Image Preview" src="assets/images/khjang.PNG"
								class="img-circle profileImg" />
						</div>
					...
					<div class="mem">
						...
						<div class="memImg">
							<img alt="Bootstrap Image Preview" src="assets/images/hschoi.PNG"
								class="img-circle profileImg" />
						</div>
